...
import { Currency, CurrencyAmount, JSBI, Pair, Percent, Price, Token } from '@doc_failure/sushiswap-sdk'
...
export function useDerivedMintInfo(
  ...
  console.log('currencies[Field.CURRENCY_B: ' + currencies[Field.CURRENCY_B])
