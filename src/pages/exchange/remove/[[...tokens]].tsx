...
import { ChainId, Currency, NATIVE, Percent, WNATIVE } from '@doc_failure/sushiswap-sdk'
...
export default function Remove() {
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | Theta-Launcher</title>
        <meta key="description" name="description" content="Remove liquidity from the Theta-Launcher AMM" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Remove liquidity from the Theta-Launcher AMM"
        />
        <meta key="og:description" property="og:description" content="Remove liquidity from the Theta-Launcher AMM" />
      </Head>
